function varargout = ffmpegtranscode(varargin)
...
% rev. 7 : (03-14-2019) Added hidden input argument parseonly
...
% hidden option
if parseonly
   varargout = {inopts,outopts,glopts,p.Unmatched,{tformcleanupfcn,gifcleanupfcn}};
   return
end
