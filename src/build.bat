...
set MEX_SRC_FILES=main.cpp ffmpegOption.cpp ffmpegOptionsContext.cpp ffmpegOptionsContextInput.cpp ffmpegBase.cpp ffmpegInputFile.cpp ffmpegFilterGraph.cpp 
REM ffmpegInputStream.cpp  ffmpegInputStreamAudio.cpp ffmpegInputStreamVideo.cpp ffmpegInputStreamSubtitle.cpp
...
set compilerflags=/GR /W3 /wd4819 /EHs /D_CRT_SECURE_NO_DEPRECATE /D_SCL_SECURE_NO_DEPRECATE /D_SECURE_SCL=0 /D_WIN32 /nologo /MD /I"%FFMPEG_INCLUDE_DIR%" /I"%MATLAB_INCLUDE_DIR%" /DMATLAB_MEX_FILE 
